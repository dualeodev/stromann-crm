  ...
  return (
    <>
      ...
      <div className="ind-hero">
        <div>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 24 }}>
            ...
            <Btn variant="secondary" size="lg" style={{ background: "transparent", color: "#fff", borderColor: "rgba(255,255,255,0.3)" }} href="mailto:hr@stromann.vn">Gửi CV chủ động</Btn>
          </div>
      ...
      <section className="section" id="jobs">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {filtered.map(j => (
            <Link key={j.id} href={`/recruitment/${j.id}`} className="card" style={{
