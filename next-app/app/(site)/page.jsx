...
import { Tag, Btn, SectHead, ProductImage, IndustryImage } from "@/components/ui";
    ...
    <div className="hero hero--figma">
      <div className="hero__left">
        ...
        <div className="hero__ctas">
          ...
          <Btn href="/products" style={{ background: "transparent", color: "#fff", border: "none", padding: "12px 0" }}>KHÁM PHÁ SẢN PHẨM →</Btn>
        </div>
      </div>
    ...
    <>
      ...
      <section className="section section--alt section--swatch">
        ...
        <div className="swatch-grid">
          {INDUSTRIES.map((ind, i) => (
            <Link key={ind.id} href="/industries" className="swatch-card" style={{ "--sw": ind.swatch }}>
      ...
      <section className="section section--alt">
        <SectHead row eyebrow="SẢN PHẨM" title="Phụ gia chuyên biệt nổi bật"
          right={<Link href="/products" className="link-arrow">Xem tất cả sản phẩm →</Link>} />
      ...
      <section className="section">
        <SectHead row eyebrow="TIN TỨC" title="Cập nhật mới từ Stromann"
          right={<Link href="/news" className="link-arrow">Xem tất cả tin →</Link>} />
