// data.jsx — sample content for Stromann VN
...
const INDUSTRIES = [
  {
    ...
    swatch: "#C8332D", // đỏ sơn công nghiệp
  ...
  },
  {
    ...
    swatch: "#E8B22F", // vàng masterbatch
...
window.STROMANN_DATA = { NAV_PRODUCTS, INDUSTRIES, WHY_ROWS, PRODUCTS, NEWS, TIMELINE, STATS };
