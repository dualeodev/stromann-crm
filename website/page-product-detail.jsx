// page-product-detail.jsx
const { Tag, Btn, ProductImage, IndustryImage } = window.SUI;
const { Breadcrumb } = window.SLAYOUT;
const { PRODUCTS } = window.STROMANN_DATA;
      ...
      <section className="pd-hero">
        ...
        <div className="pd-info">
          ...
          <div className="pd-info__ctas">
            <Btn variant="primary" size="lg" as="a" href="#/quote">Yêu cầu báo giá</Btn>
        ...
        {tab === "desc" && (
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 48 }}>
            ...
            <aside style={{ background: "#fff", padding: 24, borderRadius: 12, border: "1px solid var(--n-200)", height: "fit-content" }}>
              ...
              <Btn variant="primary" style={{ width: "100%" }} as="a" href="#/contact">Liên hệ kỹ sư</Btn>
      ...
      <section className="section">
        ...
        <div className="product-grid">
          {PRODUCTS.filter(x => x.group === p.group && x.id !== p.id).slice(0, 4).map(rp => (
            <a key={rp.id} href={`#/products/${rp.id}`} className="prod-card">
